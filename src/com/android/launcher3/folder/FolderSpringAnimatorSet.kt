    ...
    companion object Factory {
        ...
        private fun addAlphaAndColorAnimators(
            ...
            with(folder) {
                ...
                val isOpening = animationData.isOpening
                val initialColor = org.acreetionos.launcher.util.resolveFolderPreviewColor(context)
                val finalColor = org.acreetionos.launcher.util.resolveFolderBackgroundColor(context)
