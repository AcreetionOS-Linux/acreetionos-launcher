...
package org.acreetionos.launcher.flowerpot.rules
...
sealed class CodeRules(vararg val args: String) {
    ...
    class Category(vararg args: String) : CodeRules(*args) {
        ...
        override fun matches(info: ApplicationInfo) = Utilities.ATLEAST_O && info.category == category
    }

    companion object {
        private val cache = mutableMapOf<Pair<String, Array<out String>>, CodeRules>()
