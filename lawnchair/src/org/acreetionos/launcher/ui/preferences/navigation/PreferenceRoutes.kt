...
import org.acreetionos.launcher.ui.preferences.destinations.SearchRoute
import org.acreetionos.launcher.ui.preferences.destinations.ShapeRoute
...
@Serializable
data object AcreetionHub : PreferenceRootRoute, PreferenceDeepLink {
    override val deepLink = "$URI/acreetion-hub"
}

@Serializable
data object AcreetionFeed : PreferenceRootRoute, PreferenceDeepLink {
    override val deepLink = "$URI/acreetion-feed"
}

@Serializable
data object PrivacyShield : PreferenceRootRoute, PreferenceDeepLink {
    override val deepLink = "$URI/privacy-shield"
}

@Serializable
data object AcreetionSpecificSettings : PreferenceRootRoute, PreferenceDeepLink {
    override val deepLink = "$URI/acreetion-specific"
}

@Serializable
data object AcreetionQuickPanelSettings : PreferenceRootRoute, PreferenceDeepLink {
    override val deepLink = "$URI/acreetion-quick-panel"
}
