...
import org.acreetionos.launcher.ui.AndroidText
...
import org.acreetionos.launcher.ui.preferences.components.layout.PreferenceGroupItem
...
fun FontSelection(
    ...
    val items by produceState(initialValue = emptyList<FontCache.Family>()) {
        ...
        val firaCodeVariants = HashMap<String, FontCache.Font>()
        firaCodeVariants["regular"] = FontCache.AssetFont(context.assets, "Fira Code")
        firaCodeVariants["700"] = FontCache.AssetFont(context.assets, "Fira Code Bold")
        list.add(FontCache.Family("Fira Code", firaCodeVariants))
