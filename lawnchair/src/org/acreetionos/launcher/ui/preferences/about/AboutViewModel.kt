package org.acreetionos.launcher.ui.preferences.about
...
class AboutViewModel(
    ...
    companion object {
        private val team = listOf(
            TeamMember(
                name = "Natalie Cole-Clift Spiva",
                role = Role.Development,
                photoUrl = "https://acreetionos.org/natalie_avatar_new.webp",
                socialUrl = "https://github.com/spivanatalie64",
                githubUsername = "spivanatalie64",
            ),
            TeamMember(
                name = "Darren Clift",
                role = Role.Development,
                photoUrl = "https://acreetionos.org/darren_avatar_new.webp",
                socialUrl = "https://github.com/darrenclift",
                githubUsername = "darrenclift",
            ),
            TeamMember(
                name = "Amogh Lele",
                role = Role.Development,
        ...
        private val topLinks = listOf(
            Link(
                ...
                url = "https://acreetionos.org/newsletter.html",
            ),
            Link(
                iconResId = R.drawable.ic_help,
                labelResId = R.string.support,
                url = "https://acreetionos.org/wiki.html",
            ),
            Link(
                iconResId = R.drawable.ic_github,
                labelResId = R.string.github,
                url = "https://github.com/AcreetionOS-Code",
            ),
            Link(
            ...
            Link(
                ...
                url = "https://acreetionos.org/donate.html",
            ),
        )
        ...
        private val bottomLinks = listOf(
            Link(
                ...
                url = "https://discord.gg/VHqQkJASw7",
            ),
            Link(
                iconResId = R.drawable.ic_about,
                labelResId = R.string.acreetion_hub_title,
