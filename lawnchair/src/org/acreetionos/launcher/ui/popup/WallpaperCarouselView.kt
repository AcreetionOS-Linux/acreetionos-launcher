package org.acreetionos.launcher.ui.popup
...
import org.acreetionos.launcher.data.wallpaper.model.WallpaperViewModel
import org.acreetionos.launcher.launcher
import org.acreetionos.launcher.util.decodeSampledBitmapFromFile
import org.acreetionos.launcher.util.observeOnce
import org.acreetionos.launcher.views.component.IconFrame
...
class WallpaperCarouselView @JvmOverloads constructor(
    ...
    private fun observeWallpapers() {
        viewModel.wallpapers.observeOnce(context as LifecycleOwner) { wallpapers ->
