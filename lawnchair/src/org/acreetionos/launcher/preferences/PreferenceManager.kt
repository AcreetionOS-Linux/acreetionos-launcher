...
import org.acreetionos.launcher.util.getApkVersionComparison
...
class PreferenceManager @Inject constructor(
    ...
    // AcreetionOS: workspace labels default to bundled Fira Code (site's mono signature)
    val fontWorkspace = FontPref("pref_workspaceFont", FontCache.AssetFont(context.assets, "Fira Code"), recreate)
