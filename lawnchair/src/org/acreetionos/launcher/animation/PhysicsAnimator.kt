...
package org.acreetionos.launcher.animation
...
import org.acreetionos.launcher.animation.PhysicsAnimator.Companion.getInstance
 ...
 */
val <T : View> T.physicsAnimator: PhysicsAnimator<T> get() {
...
class PhysicsAnimator<T> private constructor(target: T) {
    ...
    fun fling(
        ...
        if (verboseLogging) {
            Log.d(
                TAG,
                "Flinging ${getReadablePropertyName(property)} " +
