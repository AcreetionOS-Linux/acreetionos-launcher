...
import org.acreetionos.launcher.resolveIntent
...
sealed class QsbSearchProvider(
    ...
    companion object {
        ...
        /**
         * Resolve the search provider using its ID, or use Qwant as a fallback.
         */
        fun fromId(id: String): QsbSearchProvider = values().firstOrNull { it.id == id } ?: Qwant
