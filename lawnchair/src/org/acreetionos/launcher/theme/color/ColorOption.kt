package org.acreetionos.launcher.theme.color

import android.graphics.Color
import androidx.compose.ui.res.stringResource
import org.acreetionos.launcher.ui.preferences.components.colorpreference.ColorPreferenceEntry
import org.acreetionos.launcher.ui.theme.getSystemAccent
import org.acreetionos.launcher.wallpaper.WallpaperManagerCompat
...
sealed class ColorOption {
    ...
    companion object {
        val AcreetionGreen = CustomColor(0xFF2ECC71)
        val AcreetionPurple = CustomColor(0xFF9B59B6)
        val StormBlue = CustomColor(0xFF61AFEF)
        val FlasherAmber = CustomColor(0xFFF39C12)
        val ObsidianDark = CustomColor(0xFF121212)
        ...
        fun fromString(stringValue: String) = when (stringValue) {
            ...
            "default" -> Default
            "acreetion_green" -> AcreetionGreen
            "acreetion_purple" -> AcreetionPurple
            "storm_blue" -> StormBlue
            "flasher_amber" -> FlasherAmber
